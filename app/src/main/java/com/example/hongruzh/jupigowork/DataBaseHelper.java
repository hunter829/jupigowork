...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME + "(ID INTEGER PRIMARY KEY AUTOINCREMENT,NAME TEXT,COLOR TEXT,CODE INTEGER)");
    }
    ...
    public boolean insertData(String name,String color,Integer code){
        SQLiteDatabase db = this.getWritableDatabase();
